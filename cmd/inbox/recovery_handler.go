...
func (h *RecoveryActivityHandler) HandleActivity(ctx context.Context, activity *activitypub.Activity) error {
	...
	if recoveryData, ok := object["lesser:recoveryConfirmation"].(map[string]interface{}); ok {
		return h.handleTrusteeConfirmation(ctx, activity, recoveryData)
	}

	// Check for trustee acceptance of invitation
	if inviteData, ok := object["lesser:trusteeAcceptance"].(map[string]interface{}); ok {
...
func (h *RecoveryActivityHandler) handleTrusteeConfirmation(ctx context.Context, activity *activitypub.Activity, recoveryData map[string]interface{}) error {
...
func (h *RecoveryActivityHandler) handleTrusteeAcceptance(ctx context.Context, activity *activitypub.Activity, inviteData map[string]interface{}) error {
...
func CreateRecoveryConfirmationActivity(requestID, trusteeActorID, systemActorID string) *activitypub.Activity {
	...
	return &activitypub.Activity{
		...
		Object: map[string]interface{}{
			...
			"lesser:recoveryConfirmation": map[string]interface{}{
...
func CreateTrusteeAcceptanceActivity(inviterUsername, trusteeActorID, inviterActorID string) *activitypub.Activity {
	...
	return &activitypub.Activity{
		...
		Object: map[string]interface{}{
			...
			"lesser:trusteeAcceptance": map[string]interface{}{
