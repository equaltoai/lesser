...
func printUsageTo(w io.Writer) {
	...
	_, _ = fmt.Fprintln(w, "  lesser verify [all|ci|docs|ai-training|schema|audit|supply-chain|graphql-coverage|openapi|mcp-auth-cutover|account-hydration|status-contract|inventory|lambda-set|unit|smoke|cdk] [--smoke] [--cdk]")
