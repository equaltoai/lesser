...
func printUsageTo(w io.Writer) {
	...
	_, _ = fmt.Fprintln(w, "  lesser up --app <slug> --base-domain <example.com> --aws-profile <profile> [--stage dev|staging|live] [--bootstrap-wallet-address <0x...>] [--with-staging] [--out <path>] [--rebuild-lambdas]")
	_, _ = fmt.Fprintln(w, "  lesser init-admin --app <slug> --base-domain <example.com> --aws-profile <profile> --stage dev|staging|live --wallet-address <0x...> --signature <0x...> [--message <string> | --message-file <path>] [--username <username>] [--chain-id <n>]")
