...
var apiAppTheoryRoutes = []apptheoryRoute{
	...
	// Statuses + timelines.
	{method: "POST", pattern: "/api/v1/notes"},
	{method: "GET", pattern: "/api/v1/notes/{object_id}"},
	{method: "POST", pattern: "/api/v1/notes/{id}/vote"},
	{method: "POST", pattern: "/api/v1/statuses"},
	{method: "PUT", pattern: "/api/v1/statuses/{id}"},
	{method: "DELETE", pattern: "/api/v1/statuses/{id}"},
	{method: "GET", pattern: "/api/v1/statuses/{id}"},
	{method: "GET", pattern: "/api/v1/statuses/{id}/context"},
	{method: "GET", pattern: "/api/v1/statuses/{id}/history"},
	{method: "GET", pattern: "/api/v1/statuses/{id}/source"},
	{method: "GET", pattern: "/api/v1/statuses/{id}/favourited_by"},
	{method: "GET", pattern: "/api/v1/statuses/{id}/reblogged_by"},
	{method: "GET", pattern: "/api/v1/timelines/home"},
	{method: "GET", pattern: "/api/v1/timelines/public"},
	{method: "GET", pattern: "/api/v1/timelines/tag/{hashtag}"},
	{method: "GET", pattern: "/api/v1/timelines/list/{list_id}"},
	{method: "GET", pattern: "/api/v1/timelines/direct"},
	{method: "GET", pattern: "/api/v1/timelines/link"},
	{method: "GET", pattern: "/api/v1/trends"},
	{method: "GET", pattern: "/api/v1/trends/tags"},
	{method: "GET", pattern: "/api/v1/trends/statuses"},
	{method: "GET", pattern: "/api/v1/trends/links"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/favourite"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/unfavourite"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/reblog"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/unreblog"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/bookmark"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/unbookmark"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/pin"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/unpin"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/mute"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/unmute"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/translate"},
	{method: "GET", pattern: "/api/v1/bookmarks"},
	{method: "GET", pattern: "/api/v1/favourites"},
	{method: "GET", pattern: "/api/v1/lists"},
	{method: "POST", pattern: "/api/v1/lists"},
	{method: "GET", pattern: "/api/v1/lists/{id}"},
	{method: "PUT", pattern: "/api/v1/lists/{id}"},
	{method: "DELETE", pattern: "/api/v1/lists/{id}"},
	{method: "GET", pattern: "/api/v1/lists/{id}/accounts"},
	{method: "POST", pattern: "/api/v1/lists/{id}/accounts"},
	{method: "DELETE", pattern: "/api/v1/lists/{id}/accounts"},
	{method: "GET", pattern: "/api/v1/notifications"},
	{method: "GET", pattern: "/api/v1/notifications/{id}"},
	{method: "POST", pattern: "/api/v1/notifications/clear"},
	{method: "POST", pattern: "/api/v1/notifications/{id}/dismiss"},
	{method: "GET", pattern: "/api/v1/preferences"},
	{method: "PATCH", pattern: "/api/v1/preferences"},
	{method: "GET", pattern: "/api/v1/markers"},
	{method: "POST", pattern: "/api/v1/markers"},
	{method: "GET", pattern: "/api/v1/push/subscription"},
	{method: "POST", pattern: "/api/v1/push/subscription"},
	{method: "PUT", pattern: "/api/v1/push/subscription"},
	{method: "DELETE", pattern: "/api/v1/push/subscription"},
	{method: "GET", pattern: "/api/v1/scheduled_statuses"},
	{method: "GET", pattern: "/api/v1/scheduled_statuses/{id}"},
	{method: "PUT", pattern: "/api/v1/scheduled_statuses/{id}"},
	{method: "DELETE", pattern: "/api/v1/scheduled_statuses/{id}"},
	{method: "GET", pattern: "/api/v1/directory"},
	{method: "GET", pattern: "/api/v1/suggestions"},
	{method: "DELETE", pattern: "/api/v1/suggestions/{account_id}"},
	{method: "GET", pattern: "/api/v1/endorsements"},
	{method: "GET", pattern: "/api/v1/announcements"},
	{method: "POST", pattern: "/api/v1/announcements/{id}/dismiss"},
	{method: "PUT", pattern: "/api/v1/announcements/{id}/reactions/{name}"},
	{method: "DELETE", pattern: "/api/v1/announcements/{id}/reactions/{name}"},
	{method: "GET", pattern: "/api/v1/custom_emojis"},
	{method: "GET", pattern: "/api/v1/search/statuses"},
	{method: "POST", pattern: "/api/v1/search/statuses"},
	{method: "GET", pattern: "/api/v1/conversations"},
	{method: "DELETE", pattern: "/api/v1/conversations/{id}"},
	{method: "POST", pattern: "/api/v1/conversations/{id}/read"},
	{method: "GET", pattern: "/api/v1/instance"},
	{method: "GET", pattern: "/api/v1/instance/peers"},
	{method: "GET", pattern: "/api/v1/instance/activity"},
	{method: "GET", pattern: "/api/v1/instance/domain_blocks"},
	{method: "GET", pattern: "/api/v1/instance/translation_languages"},
	{method: "GET", pattern: "/api/v2/instance"},
	{method: "GET", pattern: "/api/v2/search"},
	{method: "GET", pattern: "/api/v2/suggestions"},
	{method: "GET", pattern: "/api/v2/filters"},
	{method: "GET", pattern: "/api/v2/filters/{id}"},
	{method: "POST", pattern: "/api/v2/filters"},
	{method: "PUT", pattern: "/api/v2/filters/{id}"},
	{method: "DELETE", pattern: "/api/v2/filters/{id}"},
	{method: "GET", pattern: "/api/v2/filters/{filter_id}/keywords"},
	{method: "POST", pattern: "/api/v2/filters/{filter_id}/keywords"},
	{method: "DELETE", pattern: "/api/v2/filters/{filter_id}/keywords/{keyword_id}"},
	{method: "GET", pattern: "/api/v2/filters/{filter_id}/statuses"},
	{method: "POST", pattern: "/api/v2/filters/{filter_id}/statuses"},
	{method: "DELETE", pattern: "/api/v2/filters/{filter_id}/statuses/{status_id}"},
	{method: "GET", pattern: "/api/v2/trends"},
	{method: "GET", pattern: "/api/v2/trends/tags"},
	{method: "GET", pattern: "/api/v2/trends/statuses"},
	{method: "GET", pattern: "/api/v2/trends/links"},
	{method: "POST", pattern: "/api/v2/filters/test"},
	{method: "GET", pattern: "/api/v2/notifications/grouped"},
	{method: "POST", pattern: "/api/v2/notifications/groups/{group_id}/read"},
	{method: "POST", pattern: "/api/v1/statuses/{id}/quote"},
	{method: "GET", pattern: "/api/v1/statuses/{id}/quotes"},
	{method: "DELETE", pattern: "/api/v1/statuses/{id}/quote/{quote_id}"},

	// Moderation + admin.
	{method: "POST", pattern: "/api/v1/moderation/flag"},
	{method: "GET", pattern: "/api/v1/moderation/queue"},
	{method: "POST", pattern: "/api/v1/moderation/review"},
	{method: "GET", pattern: "/api/v1/moderation/history/{object_id}"},
	{method: "GET", pattern: "/api/v1/moderation/consensus/{event_id}"},
	{method: "GET", pattern: "/api/v1/moderation/trust"},
	{method: "PUT", pattern: "/api/v1/moderation/trust"},
	{method: "GET", pattern: "/api/v1/moderation/trust/{actor_id}/score"},
	{method: "POST", pattern: "/api/v1/reports"},
	{method: "GET", pattern: "/api/v1/reputation/{actor_id}"},
	{method: "POST", pattern: "/api/v1/reputation/export"},
	{method: "POST", pattern: "/api/v1/reputation/import"},
	{method: "POST", pattern: "/api/v1/reputation/verify"},
	{method: "POST", pattern: "/api/v1/vouches"},
	{method: "GET", pattern: "/api/v1/vouches/{actor_id}"},
	{method: "DELETE", pattern: "/api/v1/vouches/{vouch_id}"},
	{method: "GET", pattern: "/api/v1/admin/accounts"},
	{method: "POST", pattern: "/api/v1/admin/accounts"},
	{method: "GET", pattern: "/api/v1/admin/accounts/{id}"},
	{method: "POST", pattern: "/api/v1/admin/accounts/{id}/action"},
	{method: "POST", pattern: "/api/v1/admin/accounts/{id}/approve"},
	{method: "POST", pattern: "/api/v1/admin/accounts/{id}/reject"},
	{method: "POST", pattern: "/api/v1/admin/accounts/{id}/enable"},
	{method: "POST", pattern: "/api/v1/admin/accounts/{id}/unsilence"},
	{method: "POST", pattern: "/api/v1/admin/accounts/{id}/unsuspend"},
	{method: "POST", pattern: "/api/v1/admin/accounts/{id}/unsensitive"},
	{method: "GET", pattern: "/api/v1/admin/reports"},
	{method: "GET", pattern: "/api/v1/admin/reports/{id}"},
	{method: "POST", pattern: "/api/v1/admin/reports/{id}/resolve"},
	{method: "POST", pattern: "/api/v1/admin/reports/{id}/reopen"},
	{method: "POST", pattern: "/api/v1/admin/reports/{id}/assign_to_self"},
	{method: "POST", pattern: "/api/v1/admin/reports/{id}/unassign"},
	{method: "GET", pattern: "/api/v1/admin/statuses"},
	{method: "GET", pattern: "/api/v1/admin/statuses/{id}"},
	{method: "DELETE", pattern: "/api/v1/admin/statuses/{id}"},
	{method: "POST", pattern: "/api/v1/admin/statuses/{id}/sensitive"},
	{method: "POST", pattern: "/api/v1/admin/statuses/{id}/unsensitive"},
	{method: "GET", pattern: "/api/v1/admin/domain_blocks"},
	{method: "GET", pattern: "/api/v1/admin/domain_blocks/{id}"},
	{method: "POST", pattern: "/api/v1/admin/domain_blocks"},
	{method: "PUT", pattern: "/api/v1/admin/domain_blocks/{id}"},
	{method: "DELETE", pattern: "/api/v1/admin/domain_blocks/{id}"},
	{method: "GET", pattern: "/api/v1/admin/domain_allows"},
	{method: "POST", pattern: "/api/v1/admin/domain_allows"},
	{method: "DELETE", pattern: "/api/v1/admin/domain_allows/{id}"},
	{method: "GET", pattern: "/api/v1/admin/email_domain_blocks"},
	{method: "POST", pattern: "/api/v1/admin/email_domain_blocks"},
	{method: "DELETE", pattern: "/api/v1/admin/email_domain_blocks/{id}"},
	{method: "GET", pattern: "/api/v1/admin/federation/instances"},
	{method: "GET", pattern: "/api/v1/admin/federation/instance/{domain}"},
	{method: "GET", pattern: "/api/v1/admin/federation/statistics"},
	{method: "POST", pattern: "/api/v1/admin/announcements"},
	{method: "POST", pattern: "/api/v1/admin/custom_emojis"},
	{method: "PUT", pattern: "/api/v1/admin/custom_emojis/{shortcode}"},
	{method: "DELETE", pattern: "/api/v1/admin/custom_emojis/{shortcode}"},
	{method: "GET", pattern: "/api/v1/admin/moderation/overview"},
	{method: "GET", pattern: "/api/v1/admin/moderation/events"},
	{method: "POST", pattern: "/api/v1/admin/moderation/events/{id}/override"},
	{method: "GET", pattern: "/api/v1/admin/moderation/trust/graph"},
	{method: "PUT", pattern: "/api/v1/admin/moderation/trust/{from}/{to}"},
