...
func TestPublicSurfacePackageMatchesLegacyGateDecision(t *testing.T) {
	...
	tests := []struct {
		...
		{"get actor oauth protected resource metadata", http.MethodGet, "/.well-known/oauth-protected-resource/mcp/agent1", true},
		...
		{"get framework oauth authorize", http.MethodGet, "/authorize", true},
		...
		{"get account profile", http.MethodGet, "/api/v1/accounts/123", true},
		{"get account profile by username", http.MethodGet, "/api/v1/accounts/alice", true},
		{"get account lookup", http.MethodGet, "/api/v1/accounts/lookup", true},
		{"get account relationships remains private", http.MethodGet, "/api/v1/accounts/relationships", false},
		{"get account verify credentials remains private", http.MethodGet, "/api/v1/accounts/verify_credentials", false},
		...
		{"get agents directory", http.MethodGet, "/api/v1/agents", true},
		{"get agent profile", http.MethodGet, "/api/v1/agents/della-marlowe", true},
		{"get agent activity private", http.MethodGet, "/api/v1/agents/della-marlowe/activity", false},
		{"get agent memory private", http.MethodGet, "/api/v1/agents/memory/search", false},
		...
		{"post framework oauth register", http.MethodPost, "/register", true},
		...
		{"post framework oauth token", http.MethodPost, "/token", true},
		...
		{"post agent register challenge", http.MethodPost, "/api/v1/agents/register/challenge", true},
		{"post agent register", http.MethodPost, "/api/v1/agents/register", true},
		{"post agent auth challenge", http.MethodPost, "/api/v1/agents/auth/challenge", true},
		{"post agent auth token", http.MethodPost, "/api/v1/agents/auth/token", true},
		{"post agent lease session challenge", http.MethodPost, "/api/v1/agents/della-marlowe/access-leases/lease-1/session-key/challenge", true},
		{"post agent lease session key", http.MethodPost, "/api/v1/agents/della-marlowe/access-leases/lease-1/session-key", true},
		{"post agent lease renew challenge", http.MethodPost, "/api/v1/agents/della-marlowe/access-leases/lease-1/renew/challenge", true},
		{"post agent lease token", http.MethodPost, "/api/v1/agents/della-marlowe/access-leases/lease-1/token", true},
		{"post agent lease creation remains private", http.MethodPost, "/api/v1/agents/della-marlowe/access-leases", false},
		{"post agent lease owner challenge remains private", http.MethodPost, "/api/v1/agents/della-marlowe/access-leases/challenge/principal", false},
