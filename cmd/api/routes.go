...
func configureRoutes(app *apptheory.App) {
	...
	app.Post("/api/v1/agents/{username}/access-leases/challenge/principal", apiHandler.HandleCreateAgentAccessLeasePrincipalChallengeLift)
	app.Post("/api/v1/agents/{username}/access-leases/challenge/agent", apiHandler.HandleCreateAgentAccessLeaseAgentChallengeLift)
	app.Post("/api/v1/agents/{username}/access-leases", apiHandler.HandleCreateAgentAccessLeaseLift)
	app.Get("/api/v1/agents/{username}/access-leases", apiHandler.HandleListAgentAccessLeasesLift)
	app.Post("/api/v1/agents/{username}/access-leases/{leaseID}/revoke", apiHandler.HandleRevokeAgentAccessLeaseLift)
	...
	app.Get("/api/v1/agents/{username}/runtime-sessions", apiHandler.HandleListAgentRuntimeSessionsLift)
	app.Post("/api/v1/agents/{username}/runtime-sessions/{sessionID}/revoke", apiHandler.HandleRevokeAgentRuntimeSessionLift)
