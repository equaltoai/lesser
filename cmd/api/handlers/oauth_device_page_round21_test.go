...
func TestHandleOAuthDevicePageLift(t *testing.T) {
	t.Run("renders hosted device approval page with prefilled code", func(t *testing.T) {
		...
		require.Contains(t, body, "verifiedDeviceRequest = payload")
		require.Contains(t, body, "client_id: verifiedDeviceRequest.client_id")
		require.Contains(t, body, "scope: (verifiedDeviceRequest.scopes || []).join(\" \")")
