...
func (h *Handler) HandleNodeInfoWellKnown(ctx context.Context, request events.APIGatewayV2HTTPRequest) (*events.APIGatewayV2HTTPResponse, error) {
...
func (h *Handler) HandleNodeInfo(ctx context.Context, request events.APIGatewayV2HTTPRequest) (*events.APIGatewayV2HTTPResponse, error) {
	...
	// Get post statistics
	localPosts, err := h.store.GetLocalPostCount(ctx)
	if err != nil {
