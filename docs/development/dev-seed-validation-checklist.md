...
- [x] Run `./lesser dev seed-and-validate` to automatically seed the database and run validation tests.
...
- [x] The `./lesser dev seed-and-validate` workflow creates baseline personas (admin, moderator, member, locked user, bot) via the API-driven seeder.
...
- [x] The `./lesser dev seed-and-validate` workflow automatically runs the GraphQL validation scripts.
...
- [ ] The `./lesser dev seed-and-validate` workflow provides a single command to seed and validate the environment.
