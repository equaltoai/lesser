...
func TestRelationshipRepository_counts_and_pending_checks_error_paths(t *testing.T) {
	...
	// CountFollowers error path (keyed walk, wave #1469)
...
func TestRelationshipRepository_CountRelationshipsByDomain_branches(t *testing.T) {
	...
	mockQuery.On("AllPaginated", mock.AnythingOfType("*[]models.RelationshipRecord")).Return(nil, dynamormerrors.ErrItemNotFound).Twice()
