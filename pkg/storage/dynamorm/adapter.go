...
func (s *StorageAdapter) GetActorByID(ctx context.Context, actorID string) (*activitypub.Actor, error) {
	...
	if actorRepository, ok := actorRepo.(interface{ GetActorByID(ctx context.Context, actorID string) (*activitypub.Actor, error) }); ok {
		return actorRepository.GetActorByID(ctx, actorID)
	}
	// Fallback to GetActor with actorID as username
	if basicActorRepo, ok := actorRepo.(interface{ GetActor(ctx context.Context, username string) (*activitypub.Actor, error) }); ok {
...
func (s *StorageAdapter) GetActorPrivateKey(ctx context.Context, username string) (string, error) {
	actorRepo := s.Actor() // Use the interface{} method
	if keyRepo, ok := actorRepo.(interface{ GetActorPrivateKey(ctx context.Context, username string) (string, error) }); ok {
		return keyRepo.GetActorPrivateKey(ctx, username)
	}
	// Try GetActorKeys method if available
	if keysRepo, ok := actorRepo.(interface{ GetActorKeys(ctx context.Context, username string) (string, string, error) }); ok {
...
func (s *StorageAdapter) UpdateActorKeys(ctx context.Context, username, publicKey, privateKey string) error {
	actorRepo := s.Actor() // Use the interface{} method
	if keyRepo, ok := actorRepo.(interface{ UpdateActorKeys(ctx context.Context, username, publicKey, privateKey string) error }); ok {
...
func (s *StorageAdapter) GetUserByID(ctx context.Context, userID string) (interface{}, error) {
	...
	if idRepo, ok := userRepo.(interface{ GetUserByID(ctx context.Context, userID string) (interface{}, error) }); ok {
		return idRepo.GetUserByID(ctx, userID)
	}
	// Try GetUserByNumericID if available
	if numRepo, ok := userRepo.(interface{ GetUserByNumericID(ctx context.Context, userID string) (interface{}, error) }); ok {
		return numRepo.GetUserByNumericID(ctx, userID)
	}
	// Fallback to GetUser with userID as username
	if basicRepo, ok := userRepo.(interface{ GetUser(ctx context.Context, username string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) GetUserPreferences(ctx context.Context, username string) (interface{}, error) {
	userRepo := s.User()
	if prefRepo, ok := userRepo.(interface{ GetUserPreferences(ctx context.Context, username string) (interface{}, error) }); ok {
		return prefRepo.GetUserPreferences(ctx, username)
	}
	if prefMapRepo, ok := userRepo.(interface{ GetPreferences(ctx context.Context, username string) (map[string]any, error) }); ok {
...
func (s *StorageAdapter) ValidateCredentials(ctx context.Context, username, password string) (interface{}, error) {
	...
	if validationRepo, ok := userRepo.(interface{ ValidateCredentials(ctx context.Context, username, password string) (interface{}, error) }); ok {
		return validationRepo.ValidateCredentials(ctx, username, password)
	}
	// Try account repository validation
	accountRepo := s.Account()
	if accValidationRepo, ok := accountRepo.(interface{ ValidateCredentials(ctx context.Context, username, password string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdatePassword(ctx context.Context, username, hashedPassword string) error {
	userRepo := s.User()
	if pwdRepo, ok := userRepo.(interface{ UpdatePassword(ctx context.Context, username, hashedPassword string) error }); ok {
		return pwdRepo.UpdatePassword(ctx, username, hashedPassword)
	}
	// Try account repository password update
	accountRepo := s.Account()
	if accPwdRepo, ok := accountRepo.(interface{ UpdatePassword(ctx context.Context, username, newPasswordHash string) error }); ok {
...
func (s *StorageAdapter) UpdateObject(ctx context.Context, objectID string, object interface{}) error {
	if repo := s.Object(); repo != nil {
		if objectRepo, ok := repo.(*repositories.ObjectRepository); ok {
...
func (s *StorageAdapter) DecrementReplyCount(ctx context.Context, objectID string) error {
	objectRepo := s.Object()
	if countRepo, ok := objectRepo.(interface{ DecrementReplyCount(ctx context.Context, objectID string) error }); ok {
...
func (s *StorageAdapter) GetObjectMetadata(ctx context.Context, objectID string) (interface{}, error) {
	objectRepo := s.Object()
	if metaRepo, ok := objectRepo.(interface{ GetObjectMetadata(ctx context.Context, objectID string) (interface{}, error) }); ok {
		return metaRepo.GetObjectMetadata(ctx, objectID)
	}
	// Try to get full object and extract metadata
	if basicRepo, ok := objectRepo.(interface{ GetObject(ctx context.Context, objectID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) GetObjectHistory(ctx context.Context, objectID string) ([]interface{}, error) {
	objectRepo := s.Object()
	if historyRepo, ok := objectRepo.(interface{ GetObjectHistory(ctx context.Context, objectID string) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) RestoreObjectVersion(ctx context.Context, objectID string, version int) error {
	objectRepo := s.Object()
	if versionRepo, ok := objectRepo.(interface{ RestoreObjectVersion(ctx context.Context, objectID string, version int) error }); ok {
...
func (s *StorageAdapter) UpdateActivity(ctx context.Context, activity *activitypub.Activity) error {
	...
	if updateRepo, ok := activityRepo.(interface{ UpdateActivity(ctx context.Context, activity *activitypub.Activity) error }); ok {
...
func (s *StorageAdapter) DeleteActivity(ctx context.Context, activityID string) error {
	activityRepo := s.Activity()
	if deleteRepo, ok := activityRepo.(interface{ DeleteActivity(ctx context.Context, activityID string) error }); ok {
...
func (s *StorageAdapter) ProcessInboundActivity(ctx context.Context, activity *activitypub.Activity, fromDomain string) error {
	activityRepo := s.Activity()
	if processRepo, ok := activityRepo.(interface{ ProcessInboundActivity(ctx context.Context, activity *activitypub.Activity, fromDomain string) error }); ok {
		return processRepo.ProcessInboundActivity(ctx, activity, fromDomain)
	}
	// Fallback to just storing the activity
	if basicRepo, ok := activityRepo.(interface{ CreateActivity(ctx context.Context, activity *activitypub.Activity) error }); ok {
...
func (s *StorageAdapter) ProcessOutboundActivity(ctx context.Context, activity *activitypub.Activity) error {
	activityRepo := s.Activity()
	if processRepo, ok := activityRepo.(interface{ ProcessOutboundActivity(ctx context.Context, activity *activitypub.Activity) error }); ok {
...
func (s *StorageAdapter) GetActivitiesByActor(ctx context.Context, actorID string, limit int, cursor string) ([]*activitypub.Activity, string, error) {
	activityRepo := s.Activity()
	if actorRepo, ok := activityRepo.(interface{ GetActivitiesByActor(ctx context.Context, actorID string, limit int, cursor string) ([]*activitypub.Activity, string, error) }); ok {
...
func (s *StorageAdapter) CreateRelationship(ctx context.Context, followerUsername, followingID, activityID string) error {
	if repo := s.Relationship(); repo != nil {
...
func (s *StorageAdapter) UpdateRelationshipStatus(ctx context.Context, followerUsername, followingID string, status string) error {
	...
	if statusRepo, ok := relRepo.(interface{ UpdateRelationshipStatus(ctx context.Context, followerUsername, followingID, status string) error }); ok {
...
func (s *StorageAdapter) AcceptFollowRequest(ctx context.Context, followerUsername, followingID, activityID string) error {
	if repo := s.Relationship(); repo != nil {
		if relationshipRepo, ok := repo.(*repositories.RelationshipRepository); ok {
...
func (s *StorageAdapter) GetPendingFollowRequests(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	relRepo := s.Relationship()
	if pendingRepo, ok := relRepo.(interface{ GetPendingFollowRequests(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) GetFollowersCount(ctx context.Context, username string) (int64, error) {
	relRepo := s.Relationship()
	if countRepo, ok := relRepo.(interface{ GetFollowersCount(ctx context.Context, username string) (int64, error) }); ok {
		return countRepo.GetFollowersCount(ctx, username)
	}
	// Fallback: get followers and count them
	if followersRepo, ok := relRepo.(interface{ GetFollowers(ctx context.Context, username string, limit int, cursor string) ([]string, string, error) }); ok {
...
func (s *StorageAdapter) GetFollowingCount(ctx context.Context, username string) (int64, error) {
	relRepo := s.Relationship()
	if countRepo, ok := relRepo.(interface{ GetFollowingCount(ctx context.Context, username string) (int64, error) }); ok {
		return countRepo.GetFollowingCount(ctx, username)
	}
	// Fallback: get following and count them
	if followingRepo, ok := relRepo.(interface{ GetFollowing(ctx context.Context, username string, limit int, cursor string) ([]string, string, error) }); ok {
...
func (s *StorageAdapter) BlockActor(ctx context.Context, blockerUsername, blockedUsername string) error {
	relRepo := s.Relationship()
	if blockRepo, ok := relRepo.(interface{ BlockActor(ctx context.Context, blockerUsername, blockedUsername string) error }); ok {
		return blockRepo.BlockActor(ctx, blockerUsername, blockedUsername)
	}
	if blockUserRepo, ok := relRepo.(interface{ BlockUser(ctx context.Context, blockerID, blockedID string) error }); ok {
...
func (s *StorageAdapter) UnblockActor(ctx context.Context, blockerUsername, blockedUsername string) error {
	relRepo := s.Relationship()
	if unblockRepo, ok := relRepo.(interface{ UnblockActor(ctx context.Context, blockerUsername, blockedUsername string) error }); ok {
		return unblockRepo.UnblockActor(ctx, blockerUsername, blockedUsername)
	}
	if unblockUserRepo, ok := relRepo.(interface{ UnblockUser(ctx context.Context, blockerID, blockedID string) error }); ok {
...
func (s *StorageAdapter) GetBlockedUsers(ctx context.Context, username string, limit int, cursor string) ([]string, string, error) {
	relRepo := s.Relationship()
	if blockedRepo, ok := relRepo.(interface{ GetBlockedUsers(ctx context.Context, username string, limit int, cursor string) ([]string, string, error) }); ok {
...
func (s *StorageAdapter) MuteActor(ctx context.Context, muterUsername, mutedUsername string) error {
	relRepo := s.Relationship()
	if muteRepo, ok := relRepo.(interface{ MuteActor(ctx context.Context, muterUsername, mutedUsername string) error }); ok {
		return muteRepo.MuteActor(ctx, muterUsername, mutedUsername)
	}
	if muteUserRepo, ok := relRepo.(interface{ MuteUser(ctx context.Context, muterID, mutedID string) error }); ok {
...
func (s *StorageAdapter) UnmuteActor(ctx context.Context, muterUsername, mutedUsername string) error {
	relRepo := s.Relationship()
	if unmuteRepo, ok := relRepo.(interface{ UnmuteActor(ctx context.Context, muterUsername, mutedUsername string) error }); ok {
		return unmuteRepo.UnmuteActor(ctx, muterUsername, mutedUsername)
	}
	if unmuteUserRepo, ok := relRepo.(interface{ UnmuteUser(ctx context.Context, muterID, mutedID string) error }); ok {
...
func (s *StorageAdapter) GetMutedUsers(ctx context.Context, username string, limit int, cursor string) ([]string, string, error) {
	relRepo := s.Relationship()
	if mutedRepo, ok := relRepo.(interface{ GetMutedUsers(ctx context.Context, username string, limit int, cursor string) ([]string, string, error) }); ok {
...
func (s *StorageAdapter) GetTimeline(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	...
	if tlRepo, ok := timelineRepo.(interface{ GetTimeline(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
		return tlRepo.GetTimeline(ctx, username, limit, cursor)
	}
	// Fallback to user timeline
	if userTlRepo, ok := timelineRepo.(interface{ GetUserTimeline(ctx context.Context, username string, limit int, cursor string) ([]*models.Timeline, string, error) }); ok {
...
func (s *StorageAdapter) AddToTimeline(ctx context.Context, username string, objectID string, activityType string) error {
	timelineRepo := s.Timeline()
	if addRepo, ok := timelineRepo.(interface{ AddToTimeline(ctx context.Context, username, objectID, activityType string) error }); ok {
...
func (s *StorageAdapter) RemoveFromTimeline(ctx context.Context, username, objectID string) error {
	timelineRepo := s.Timeline()
	if removeRepo, ok := timelineRepo.(interface{ RemoveFromTimeline(ctx context.Context, username, objectID string) error }); ok {
...
func (s *StorageAdapter) RemoveFromTimelines(ctx context.Context, objectID string) error {
	timelineRepo := s.Timeline()
	if removeAllRepo, ok := timelineRepo.(interface{ RemoveFromTimelines(ctx context.Context, objectID string) error }); ok {
...
func (s *StorageAdapter) FanOutPost(ctx context.Context, activity *activitypub.Activity) error {
	timelineRepo := s.Timeline()
	if fanOutRepo, ok := timelineRepo.(interface{ FanOutPost(ctx context.Context, activity *activitypub.Activity) error }); ok {
...
func (s *StorageAdapter) CreateNotification(ctx context.Context, notification interface{}) error {
	...
	if notif, ok := notification.(*models.Notification); ok {
		if repo := s.Notification(); repo != nil {
...
func (s *StorageAdapter) GetNotifications(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	...
	if getRepo, ok := notifRepo.(interface{ GetNotifications(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
		return getRepo.GetNotifications(ctx, username, limit, cursor)
	}
	if getUserRepo, ok := notifRepo.(interface{ GetUserNotifications(ctx context.Context, userID string, limit int, cursor string) ([]*models.Notification, string, error) }); ok {
		notifs, cursor, err := getUserRepo.GetUserNotifications(ctx, username, limit, cursor)
		if err != nil {
			return nil, "", err
		}
		result := make([]interface{}, len(notifs))
...
func (s *StorageAdapter) GetUnreadNotificationCount(ctx context.Context, username string) (int64, error) {
	notifRepo := s.Notification()
	if countRepo, ok := notifRepo.(interface{ GetUnreadNotificationCount(ctx context.Context, userID string) (int64, error) }); ok {
...
func (s *StorageAdapter) MarkNotificationAsRead(ctx context.Context, notificationID string) error {
	notifRepo := s.Notification()
	if markRepo, ok := notifRepo.(interface{ MarkNotificationAsRead(ctx context.Context, notificationID string) error }); ok {
		return markRepo.MarkNotificationAsRead(ctx, notificationID)
	}
	if markReadRepo, ok := notifRepo.(interface{ MarkNotificationRead(ctx context.Context, notificationID string) error }); ok {
...
func (s *StorageAdapter) MarkAllNotificationsAsRead(ctx context.Context, username string) error {
	notifRepo := s.Notification()
	if markAllRepo, ok := notifRepo.(interface{ MarkAllNotificationsAsRead(ctx context.Context, userID string) error }); ok {
		return markAllRepo.MarkAllNotificationsAsRead(ctx, username)
	}
	if markAllReadRepo, ok := notifRepo.(interface{ MarkAllNotificationsRead(ctx context.Context, userID string) error }); ok {
...
func (s *StorageAdapter) DeleteNotificationsByObject(ctx context.Context, objectID string) error {
	notifRepo := s.Notification()
	if deleteByObjRepo, ok := notifRepo.(interface{ DeleteNotificationsByObject(ctx context.Context, objectID string) error }); ok {
...
func (s *StorageAdapter) SearchUsers(ctx context.Context, query string, limit int, cursor string) ([]interface{}, string, error) {
	searchRepo := s.Search()
	if userSearchRepo, ok := searchRepo.(interface{ SearchUsers(ctx context.Context, query string, limit int, cursor string) ([]interface{}, string, error) }); ok {
		return userSearchRepo.SearchUsers(ctx, query, limit, cursor)
	}
	// Fallback to account repository search
	accountRepo := s.Account()
	if accSearchRepo, ok := accountRepo.(interface{ SearchAccounts(ctx context.Context, query string, limit int, cursor string) ([]*storage.Account, string, error) }); ok {
		accs, cursor, err := accSearchRepo.SearchAccounts(ctx, query, limit, cursor)
		if err != nil {
			return nil, "", err
		}
		result := make([]interface{}, len(accs))
...
func (s *StorageAdapter) SearchStatuses(ctx context.Context, query string, limit int, cursor string) ([]interface{}, string, error) {
	searchRepo := s.Search()
	if statusSearchRepo, ok := searchRepo.(interface{ SearchStatuses(ctx context.Context, query string, limit int, cursor string) ([]interface{}, string, error) }); ok {
		return statusSearchRepo.SearchStatuses(ctx, query, limit, cursor)
	}
	// Try status repository search
	statusRepo := s.Status()
	if statRepo, ok := statusRepo.(interface{ SearchStatuses(ctx context.Context, query string, limit int, cursor string) ([]*models.Status, string, error) }); ok {
		statuses, cursor, err := statRepo.SearchStatuses(ctx, query, limit, cursor)
		if err != nil {
			return nil, "", err
		}
...
func (s *StorageAdapter) SearchHashtags(ctx context.Context, query string, limit int, cursor string) ([]interface{}, string, error) {
	searchRepo := s.Search()
	if hashtagSearchRepo, ok := searchRepo.(interface{ SearchHashtags(ctx context.Context, query string, limit int, cursor string) ([]interface{}, string, error) }); ok {
		return hashtagSearchRepo.SearchHashtags(ctx, query, limit, cursor)
	}
	// Try hashtag repository search
	hashtagRepo := s.Hashtag()
	if hashRepo, ok := hashtagRepo.(interface{ SearchHashtags(ctx context.Context, query string, limit int, cursor string) ([]*models.Hashtag, string, error) }); ok {
		hashtags, cursor, err := hashRepo.SearchHashtags(ctx, query, limit, cursor)
		if err != nil {
			return nil, "", err
		}
...
func (s *StorageAdapter) SearchAll(ctx context.Context, query string, limit int, cursor string) (interface{}, string, error) {
	searchRepo := s.Search()
	if allSearchRepo, ok := searchRepo.(interface{ SearchAll(ctx context.Context, query string, limit int, cursor string) (interface{}, string, error) }); ok {
...
func (s *StorageAdapter) GetSearchSuggestions(ctx context.Context, query string, limit int) ([]interface{}, error) {
	searchRepo := s.Search()
	if suggestRepo, ok := searchRepo.(interface{ GetSearchSuggestions(ctx context.Context, query string, limit int) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) GetTrendingHashtags(ctx context.Context, limit int) ([]interface{}, error) {
	searchRepo := s.Search()
	if trendingRepo, ok := searchRepo.(interface{ GetTrendingHashtags(ctx context.Context, limit int) ([]interface{}, error) }); ok {
		return trendingRepo.GetTrendingHashtags(ctx, limit)
	}
	// Try hashtag repository
	hashtagRepo := s.Hashtag()
	if trendHashtagRepo, ok := hashtagRepo.(interface{ GetTrendingHashtags(ctx context.Context, limit int) ([]*models.Hashtag, error) }); ok {
...
func (s *StorageAdapter) GetTrendingStatuses(ctx context.Context, limit int, cursor string) ([]interface{}, string, error) {
	searchRepo := s.Search()
	if trendingRepo, ok := searchRepo.(interface{ GetTrendingStatuses(ctx context.Context, limit int, cursor string) ([]interface{}, string, error) }); ok {
		return trendingRepo.GetTrendingStatuses(ctx, limit, cursor)
	}
	// Try status repository
	statusRepo := s.Status()
	if trendStatusRepo, ok := statusRepo.(interface{ GetTrendingStatuses(ctx context.Context, limit int, cursor string) ([]*models.Status, string, error) }); ok {
...
func (s *StorageAdapter) CreateSession(ctx context.Context, session interface{}) error {
	accountRepo := s.Account()
	if sessionRepo, ok := accountRepo.(interface{ CreateSession(ctx context.Context, session interface{}) error }); ok {
...
func (s *StorageAdapter) UpdateSession(ctx context.Context, session interface{}) error {
	accountRepo := s.Account()
	if sessionRepo, ok := accountRepo.(interface{ UpdateSession(ctx context.Context, session interface{}) error }); ok {
...
func (s *StorageAdapter) CleanupExpiredSessions(ctx context.Context) error {
	accountRepo := s.Account()
	if cleanupRepo, ok := accountRepo.(interface{ CleanupExpiredSessions(ctx context.Context) error }); ok {
...
func (s *StorageAdapter) ValidateToken(ctx context.Context, token string) (interface{}, error) {
	oauthRepo := s.OAuth()
	if tokenRepo, ok := oauthRepo.(interface{ ValidateToken(ctx context.Context, token string) (interface{}, error) }); ok {
		return tokenRepo.ValidateToken(ctx, token)
	}
	// Try account repository
	accountRepo := s.Account()
	if accTokenRepo, ok := accountRepo.(interface{ ValidateToken(ctx context.Context, token string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) CreateAccessToken(ctx context.Context, token interface{}) error {
	oauthRepo := s.OAuth()
	if tokenRepo, ok := oauthRepo.(interface{ CreateAccessToken(ctx context.Context, token interface{}) error }); ok {
...
func (s *StorageAdapter) GetAccessToken(ctx context.Context, tokenID string) (interface{}, error) {
	oauthRepo := s.OAuth()
	if tokenRepo, ok := oauthRepo.(interface{ GetAccessToken(ctx context.Context, tokenID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) RevokeAccessToken(ctx context.Context, tokenID string) error {
	oauthRepo := s.OAuth()
	if revokeRepo, ok := oauthRepo.(interface{ RevokeAccessToken(ctx context.Context, tokenID string) error }); ok {
...
func (s *StorageAdapter) CleanupExpiredTokens(ctx context.Context) error {
	oauthRepo := s.OAuth()
	if cleanupRepo, ok := oauthRepo.(interface{ CleanupExpiredTokens(ctx context.Context) error }); ok {
...
func (s *StorageAdapter) CreateOAuthState(ctx context.Context, state interface{}) error {
	oauthRepo := s.OAuth()
	if stateRepo, ok := oauthRepo.(interface{ CreateOAuthState(ctx context.Context, state interface{}) error }); ok {
...
func (s *StorageAdapter) GetOAuthState(ctx context.Context, state string) (interface{}, error) {
	oauthRepo := s.OAuth()
	if stateRepo, ok := oauthRepo.(interface{ GetOAuthState(ctx context.Context, state string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) DeleteOAuthState(ctx context.Context, state string) error {
	oauthRepo := s.OAuth()
	if stateRepo, ok := oauthRepo.(interface{ DeleteOAuthState(ctx context.Context, state string) error }); ok {
...
func (s *StorageAdapter) CreateOAuthClient(ctx context.Context, client interface{}) error {
	oauthRepo := s.OAuth()
	if clientRepo, ok := oauthRepo.(interface{ CreateOAuthClient(ctx context.Context, client interface{}) error }); ok {
...
func (s *StorageAdapter) GetOAuthClient(ctx context.Context, clientID string) (interface{}, error) {
	oauthRepo := s.OAuth()
	if clientRepo, ok := oauthRepo.(interface{ GetOAuthClient(ctx context.Context, clientID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) CreateMediaAttachment(ctx context.Context, media interface{}) error {
	mediaRepo := s.Media()
	if createRepo, ok := mediaRepo.(interface{ CreateMediaAttachment(ctx context.Context, media interface{}) error }); ok {
		return createRepo.CreateMediaAttachment(ctx, media)
	}
	if createMediaRepo, ok := mediaRepo.(interface{ CreateMedia(ctx context.Context, media *models.Media) error }); ok {
...
func (s *StorageAdapter) GetMediaAttachment(ctx context.Context, mediaID string) (interface{}, error) {
	mediaRepo := s.Media()
	if getRepo, ok := mediaRepo.(interface{ GetMediaAttachment(ctx context.Context, mediaID string) (interface{}, error) }); ok {
		return getRepo.GetMediaAttachment(ctx, mediaID)
	}
	if getMediaRepo, ok := mediaRepo.(interface{ GetMedia(ctx context.Context, mediaID string) (*models.Media, error) }); ok {
...
func (s *StorageAdapter) UpdateMediaAttachment(ctx context.Context, media interface{}) error {
	mediaRepo := s.Media()
	if updateRepo, ok := mediaRepo.(interface{ UpdateMediaAttachment(ctx context.Context, media interface{}) error }); ok {
		return updateRepo.UpdateMediaAttachment(ctx, media)
	}
	if updateMediaRepo, ok := mediaRepo.(interface{ UpdateMedia(ctx context.Context, media *models.Media) error }); ok {
		if mediaModel, ok := media.(*models.Media); ok {
...
func (s *StorageAdapter) DeleteMediaAttachment(ctx context.Context, mediaID string) error {
	mediaRepo := s.Media()
	if deleteRepo, ok := mediaRepo.(interface{ DeleteMediaAttachment(ctx context.Context, mediaID string) error }); ok {
		return deleteRepo.DeleteMediaAttachment(ctx, mediaID)
	}
	if deleteMediaRepo, ok := mediaRepo.(interface{ DeleteMedia(ctx context.Context, mediaID string) error }); ok {
...
func (s *StorageAdapter) GetMediaAttachmentsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	mediaRepo := s.Media()
	if getUserRepo, ok := mediaRepo.(interface{ GetMediaAttachmentsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
		return getUserRepo.GetMediaAttachmentsByUser(ctx, username, limit, cursor)
	}
	if getUserMediaRepo, ok := mediaRepo.(interface{ GetUserMedia(ctx context.Context, userID string, limit int, cursor string) ([]*models.Media, string, error) }); ok {
		media, cursor, err := getUserMediaRepo.GetUserMedia(ctx, username, limit, cursor)
		if err != nil {
			return nil, "", err
		}
		result := make([]interface{}, len(media))
		for i, m := range media {
			result[i] = m
		}
		return result, cursor, nil
...
func (s *StorageAdapter) QueueMediaProcessing(ctx context.Context, mediaID string, processingType interface{}) error {
	mediaRepo := s.Media()
	if queueRepo, ok := mediaRepo.(interface{ QueueMediaProcessing(ctx context.Context, mediaID string, processingType interface{}) error }); ok {
		return queueRepo.QueueMediaProcessing(ctx, mediaID, processingType)
	}
	if markRepo, ok := mediaRepo.(interface{ MarkMediaProcessing(ctx context.Context, mediaID string) error }); ok {
...
func (s *StorageAdapter) UpdateMediaProcessingStatus(ctx context.Context, mediaID string, status interface{}, metadata map[string]interface{}) error {
	mediaRepo := s.Media()
	if statusRepo, ok := mediaRepo.(interface{ UpdateMediaProcessingStatus(ctx context.Context, mediaID string, status interface{}, metadata map[string]interface{}) error }); ok {
	...
	if statusStr, ok := status.(string); ok {
		switch statusStr {
		case "ready":
			if readyRepo, ok := mediaRepo.(interface{ MarkMediaReady(ctx context.Context, mediaID string) error }); ok {
				return readyRepo.MarkMediaReady(ctx, mediaID)
			}
		case "failed":
			if failedRepo, ok := mediaRepo.(interface{ MarkMediaFailed(ctx context.Context, mediaID, errorMsg string) error }); ok {
...
func (s *StorageAdapter) GetMediaMetadata(ctx context.Context, mediaID string) (interface{}, error) {
	...
	if metaRepo, ok := mediaMetaRepo.(interface{ GetMediaMetadata(ctx context.Context, mediaID string) (interface{}, error) }); ok {
		return metaRepo.GetMediaMetadata(ctx, mediaID)
	}
	// Fallback to media repository
	mediaRepo := s.Media()
	if mediaWithMetaRepo, ok := mediaRepo.(interface{ GetMediaMetadata(ctx context.Context, mediaID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) CreateFederationInstance(ctx context.Context, instance interface{}) error {
	...
	if createRepo, ok := fedRepo.(interface{ CreateFederationInstance(ctx context.Context, instance interface{}) error }); ok {
		return createRepo.CreateFederationInstance(ctx, instance)
	}
	// Try instance repository
	instanceRepo := s.Instance()
	if instCreateRepo, ok := instanceRepo.(interface{ CreateInstance(ctx context.Context, instance interface{}) error }); ok {
...
func (s *StorageAdapter) GetFederationInstance(ctx context.Context, domain string) (interface{}, error) {
	fedRepo := s.Federation()
	if getRepo, ok := fedRepo.(interface{ GetFederationInstance(ctx context.Context, domain string) (interface{}, error) }); ok {
		return getRepo.GetFederationInstance(ctx, domain)
	}
	// Try instance repository
	instanceRepo := s.Instance()
	if instGetRepo, ok := instanceRepo.(interface{ GetInstance(ctx context.Context, domain string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdateFederationInstance(ctx context.Context, instance interface{}) error {
	fedRepo := s.Federation()
	if updateRepo, ok := fedRepo.(interface{ UpdateFederationInstance(ctx context.Context, instance interface{}) error }); ok {
		return updateRepo.UpdateFederationInstance(ctx, instance)
	}
	// Try instance repository
	instanceRepo := s.Instance()
	if instUpdateRepo, ok := instanceRepo.(interface{ UpdateInstance(ctx context.Context, instance interface{}) error }); ok {
...
func (s *StorageAdapter) GetAllFederationInstances(ctx context.Context, limit int, cursor string) ([]interface{}, string, error) {
	fedRepo := s.Federation()
	if getAllRepo, ok := fedRepo.(interface{ GetAllFederationInstances(ctx context.Context, limit int, cursor string) ([]interface{}, string, error) }); ok {
		return getAllRepo.GetAllFederationInstances(ctx, limit, cursor)
	}
	// Try instance repository
	instanceRepo := s.Instance()
	if instGetAllRepo, ok := instanceRepo.(interface{ GetAllInstances(ctx context.Context, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) RecordFederationActivity(ctx context.Context, activity interface{}) error {
	fedRepo := s.Federation()
	if recordRepo, ok := fedRepo.(interface{ RecordFederationActivity(ctx context.Context, activity interface{}) error }); ok {
...
func (s *StorageAdapter) GetFederationActivities(ctx context.Context, domain string, limit int, cursor string) ([]interface{}, string, error) {
	fedRepo := s.Federation()
	if getActivitiesRepo, ok := fedRepo.(interface{ GetFederationActivities(ctx context.Context, domain string, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) GetFederationStatistics(ctx context.Context, domain string, since time.Time) (interface{}, error) {
	fedRepo := s.Federation()
	if statsRepo, ok := fedRepo.(interface{ GetFederationStatistics(ctx context.Context, domain string, since time.Time) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdateFederationHealth(ctx context.Context, domain string, isHealthy bool, responseTime time.Duration) error {
	fedRepo := s.Federation()
	if healthRepo, ok := fedRepo.(interface{ UpdateFederationHealth(ctx context.Context, domain string, isHealthy bool, responseTime time.Duration) error }); ok {
...
func (s *StorageAdapter) GetFederationHealth(ctx context.Context, domain string) (interface{}, error) {
	fedRepo := s.Federation()
	if healthRepo, ok := fedRepo.(interface{ GetFederationHealth(ctx context.Context, domain string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) GetUnhealthyFederationInstances(ctx context.Context, limit int) ([]interface{}, error) {
	fedRepo := s.Federation()
	if unhealthyRepo, ok := fedRepo.(interface{ GetUnhealthyFederationInstances(ctx context.Context, limit int) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) CreateReport(ctx context.Context, report interface{}) error {
	...
	if reportRepo, ok := modRepo.(interface{ CreateReport(ctx context.Context, report interface{}) error }); ok {
...
func (s *StorageAdapter) GetReport(ctx context.Context, reportID string) (interface{}, error) {
	modRepo := s.Moderation()
	if reportRepo, ok := modRepo.(interface{ GetReport(ctx context.Context, reportID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdateReport(ctx context.Context, report interface{}) error {
	modRepo := s.Moderation()
	if reportRepo, ok := modRepo.(interface{ UpdateReport(ctx context.Context, report interface{}) error }); ok {
...
func (s *StorageAdapter) GetReportsByStatus(ctx context.Context, status interface{}, limit int, cursor string) ([]interface{}, string, error) {
	modRepo := s.Moderation()
	if reportRepo, ok := modRepo.(interface{ GetReportsByStatus(ctx context.Context, status interface{}, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) GetReportsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	modRepo := s.Moderation()
	if reportRepo, ok := modRepo.(interface{ GetReportsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) GetModerationQueue(ctx context.Context, filter interface{}) ([]interface{}, error) {
	modRepo := s.Moderation()
	if queueRepo, ok := modRepo.(interface{ GetModerationQueue(ctx context.Context, filter interface{}) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) CreateModerationDecision(ctx context.Context, decision interface{}) error {
	modRepo := s.Moderation()
	if decisionRepo, ok := modRepo.(interface{ CreateModerationDecision(ctx context.Context, decision interface{}) error }); ok {
...
func (s *StorageAdapter) GetModerationDecision(ctx context.Context, contentID string) (interface{}, error) {
	modRepo := s.Moderation()
	if decisionRepo, ok := modRepo.(interface{ GetModerationDecision(ctx context.Context, contentID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdateModerationDecision(ctx context.Context, contentID string, decision interface{}) error {
	modRepo := s.Moderation()
	if decisionRepo, ok := modRepo.(interface{ UpdateModerationDecision(ctx context.Context, contentID string, decision interface{}) error }); ok {
...
func (s *StorageAdapter) CreateFlag(ctx context.Context, flag interface{}) error {
	modRepo := s.Moderation()
	if flagRepo, ok := modRepo.(interface{ CreateFlag(ctx context.Context, flag interface{}) error }); ok {
...
func (s *StorageAdapter) GetFlags(ctx context.Context, objectID string) ([]interface{}, error) {
	modRepo := s.Moderation()
	if flagRepo, ok := modRepo.(interface{ GetFlags(ctx context.Context, objectID string) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) GetFlagsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	modRepo := s.Moderation()
	if flagRepo, ok := modRepo.(interface{ GetFlagsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) CreateDomainBlock(ctx context.Context, domain string, reason string) error {
	...
	if blockRepo, ok := domainRepo.(interface{ CreateDomainBlock(ctx context.Context, domain, reason string) error }); ok {
...
func (s *StorageAdapter) RemoveDomainBlock(ctx context.Context, domain string) error {
	domainRepo := s.DomainBlock()
	if removeRepo, ok := domainRepo.(interface{ RemoveDomainBlock(ctx context.Context, domain string) error }); ok {
		return removeRepo.RemoveDomainBlock(ctx, domain)
	}
	if deleteRepo, ok := domainRepo.(interface{ DeleteDomainBlock(ctx context.Context, domain string) error }); ok {
...
func (s *StorageAdapter) IsDomainBlocked(ctx context.Context, domain string) (bool, error) {
	domainRepo := s.DomainBlock()
	if checkRepo, ok := domainRepo.(interface{ IsDomainBlocked(ctx context.Context, domain string) (bool, error) }); ok {
...
func (s *StorageAdapter) GetDomainBlocks(ctx context.Context, limit int, cursor string) ([]interface{}, string, error) {
	domainRepo := s.DomainBlock()
	if getRepo, ok := domainRepo.(interface{ GetDomainBlocks(ctx context.Context, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) SetDNSCache(ctx context.Context, hostname string, record interface{}) error {
	dnsRepo := s.DNSCache()
	if setRepo, ok := dnsRepo.(interface{ SetDNSCache(ctx context.Context, hostname string, record interface{}) error }); ok {
...
func (s *StorageAdapter) GetDNSCache(ctx context.Context, hostname string) (interface{}, error) {
	dnsRepo := s.DNSCache()
	if getRepo, ok := dnsRepo.(interface{ GetDNSCache(ctx context.Context, hostname string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) DeleteDNSCache(ctx context.Context, hostname string) error {
	dnsRepo := s.DNSCache()
	if deleteRepo, ok := dnsRepo.(interface{ DeleteDNSCache(ctx context.Context, hostname string) error }); ok {
...
func (s *StorageAdapter) CleanupExpiredDNSCache(ctx context.Context) error {
	dnsRepo := s.DNSCache()
	if cleanupRepo, ok := dnsRepo.(interface{ CleanupExpiredDNSCache(ctx context.Context) error }); ok {
...
func (s *StorageAdapter) TrackDynamoRead(ctx context.Context, tableName string, units int64) error {
	costRepo := s.Cost()
	if trackRepo, ok := costRepo.(interface{ TrackDynamoRead(ctx context.Context, tableName string, units int64) error }); ok {
...
func (s *StorageAdapter) TrackDynamoWrite(ctx context.Context, tableName string, units int64) error {
	costRepo := s.Cost()
	if trackRepo, ok := costRepo.(interface{ TrackDynamoWrite(ctx context.Context, tableName string, units int64) error }); ok {
...
func (s *StorageAdapter) TrackDynamoOperation(ctx context.Context, operation interface{}) error {
	costRepo := s.Cost()
	if trackRepo, ok := costRepo.(interface{ TrackDynamoOperation(ctx context.Context, operation interface{}) error }); ok {
...
func (s *StorageAdapter) GetCostSummary(ctx context.Context, since time.Time) (interface{}, error) {
	costRepo := s.Cost()
	if summaryRepo, ok := costRepo.(interface{ GetCostSummary(ctx context.Context, since time.Time) (interface{}, error) }); ok {
...
func (s *StorageAdapter) GetDailyCostSummary(ctx context.Context, date time.Time) (interface{}, error) {
	costRepo := s.Cost()
	if dailyRepo, ok := costRepo.(interface{ GetDailyCostSummary(ctx context.Context, date time.Time) (interface{}, error) }); ok {
...
func (s *StorageAdapter) TrackAWSCost(ctx context.Context, service string, operation string, cost float64) error {
	costRepo := s.Cost()
	if awsRepo, ok := costRepo.(interface{ TrackAWSCost(ctx context.Context, service, operation string, cost float64) error }); ok {
...
func (s *StorageAdapter) TrackLambdaInvocation(ctx context.Context, functionName string, duration time.Duration) error {
	costRepo := s.Cost()
	if lambdaRepo, ok := costRepo.(interface{ TrackLambdaInvocation(ctx context.Context, functionName string, duration time.Duration) error }); ok {
...
func (s *StorageAdapter) TrackS3Operation(ctx context.Context, bucket string, operation string, bytes int64) error {
	costRepo := s.Cost()
	if s3Repo, ok := costRepo.(interface{ TrackS3Operation(ctx context.Context, bucket, operation string, bytes int64) error }); ok {
...
func (s *StorageAdapter) GetCostAlerts(ctx context.Context) ([]interface{}, error) {
	costRepo := s.Cost()
	if alertsRepo, ok := costRepo.(interface{ GetCostAlerts(ctx context.Context) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) CreateCostAlert(ctx context.Context, alert interface{}) error {
	costRepo := s.Cost()
	if alertRepo, ok := costRepo.(interface{ CreateCostAlert(ctx context.Context, alert interface{}) error }); ok {
...
func (s *StorageAdapter) UpdateCostAlert(ctx context.Context, alertID string, alert interface{}) error {
	costRepo := s.Cost()
	if alertRepo, ok := costRepo.(interface{ UpdateCostAlert(ctx context.Context, alertID string, alert interface{}) error }); ok {
...
func (s *StorageAdapter) RecordActivity(ctx context.Context, activityType, actorID string, timestamp time.Time) error {
	...
	if recordRepo, ok := analyticsRepo.(interface{ RecordActivity(ctx context.Context, activityType, actorID string, timestamp time.Time) error }); ok {
...
func (s *StorageAdapter) RecordInstanceActivity(ctx context.Context, activityType string, timestamp time.Time) error {
	analyticsRepo := s.Analytics()
	if recordRepo, ok := analyticsRepo.(interface{ RecordInstanceActivity(ctx context.Context, activityType string, timestamp time.Time) error }); ok {
...
func (s *StorageAdapter) RecordHashtagUsage(ctx context.Context, hashtag, objectID, actorID string) error {
	analyticsRepo := s.Analytics()
	if recordRepo, ok := analyticsRepo.(interface{ RecordHashtagUsage(ctx context.Context, hashtag, objectID, actorID string) error }); ok {
		return recordRepo.RecordHashtagUsage(ctx, hashtag, objectID, actorID)
	}
	// Try hashtag repository
	hashtagRepo := s.Hashtag()
	if hashUsageRepo, ok := hashtagRepo.(interface{ RecordHashtagUsage(ctx context.Context, hashtag, objectID, actorID string) error }); ok {
...
func (s *StorageAdapter) RecordLinkShare(ctx context.Context, link, objectID, actorID string) error {
	analyticsRepo := s.Analytics()
	if recordRepo, ok := analyticsRepo.(interface{ RecordLinkShare(ctx context.Context, link, objectID, actorID string) error }); ok {
...
func (s *StorageAdapter) RecordStatusEngagement(ctx context.Context, objectID, engagementType, actorID string) error {
	analyticsRepo := s.Analytics()
	if recordRepo, ok := analyticsRepo.(interface{ RecordStatusEngagement(ctx context.Context, objectID, engagementType, actorID string) error }); ok {
...
func (s *StorageAdapter) GetInstanceMetrics(ctx context.Context, since time.Time) (interface{}, error) {
	analyticsRepo := s.Analytics()
	if metricsRepo, ok := analyticsRepo.(interface{ GetInstanceMetrics(ctx context.Context, since time.Time) (interface{}, error) }); ok {
		return metricsRepo.GetInstanceMetrics(ctx, since)
	}
	// Try metrics repository
	metricsDataRepo := s.MetricRecord()
	if metricRepo, ok := metricsDataRepo.(interface{ GetInstanceMetrics(ctx context.Context, since time.Time) (interface{}, error) }); ok {
...
func (s *StorageAdapter) GetUserActivityMetrics(ctx context.Context, username string, since time.Time) (interface{}, error) {
	analyticsRepo := s.Analytics()
	if metricsRepo, ok := analyticsRepo.(interface{ GetUserActivityMetrics(ctx context.Context, username string, since time.Time) (interface{}, error) }); ok {
...
func (s *StorageAdapter) GetContentMetrics(ctx context.Context, since time.Time) (interface{}, error) {
	analyticsRepo := s.Analytics()
	if metricsRepo, ok := analyticsRepo.(interface{ GetContentMetrics(ctx context.Context, since time.Time) (interface{}, error) }); ok {
...
func (s *StorageAdapter) CreateScheduledStatus(ctx context.Context, scheduled interface{}) error {
	...
	if createRepo, ok := schedRepo.(interface{ CreateScheduledStatus(ctx context.Context, scheduled interface{}) error }); ok {
...
func (s *StorageAdapter) GetScheduledStatus(ctx context.Context, id string) (interface{}, error) {
	schedRepo := s.ScheduledStatus()
	if getRepo, ok := schedRepo.(interface{ GetScheduledStatus(ctx context.Context, id string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) GetScheduledStatuses(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	schedRepo := s.ScheduledStatus()
	if getListRepo, ok := schedRepo.(interface{ GetScheduledStatuses(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) UpdateScheduledStatus(ctx context.Context, scheduled interface{}) error {
	schedRepo := s.ScheduledStatus()
	if updateRepo, ok := schedRepo.(interface{ UpdateScheduledStatus(ctx context.Context, scheduled interface{}) error }); ok {
...
func (s *StorageAdapter) DeleteScheduledStatus(ctx context.Context, id string) error {
	schedRepo := s.ScheduledStatus()
	if deleteRepo, ok := schedRepo.(interface{ DeleteScheduledStatus(ctx context.Context, id string) error }); ok {
...
func (s *StorageAdapter) GetDueScheduledStatuses(ctx context.Context, before time.Time, limit int) ([]interface{}, error) {
	schedRepo := s.ScheduledStatus()
	if dueRepo, ok := schedRepo.(interface{ GetDueScheduledStatuses(ctx context.Context, before time.Time, limit int) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) MarkScheduledStatusPublished(ctx context.Context, id string) error {
	schedRepo := s.ScheduledStatus()
	if markRepo, ok := schedRepo.(interface{ MarkScheduledStatusPublished(ctx context.Context, id string) error }); ok {
...
func (s *StorageAdapter) CreateBackgroundJob(ctx context.Context, job interface{}) error {
	...
	dlqRepo := s.DLQ()
	if jobRepo, ok := dlqRepo.(interface{ CreateBackgroundJob(ctx context.Context, job interface{}) error }); ok {
...
func (s *StorageAdapter) GetBackgroundJob(ctx context.Context, jobID string) (interface{}, error) {
	dlqRepo := s.DLQ()
	if jobRepo, ok := dlqRepo.(interface{ GetBackgroundJob(ctx context.Context, jobID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdateBackgroundJobStatus(ctx context.Context, jobID string, status interface{}, result interface{}) error {
	dlqRepo := s.DLQ()
	if jobRepo, ok := dlqRepo.(interface{ UpdateBackgroundJobStatus(ctx context.Context, jobID string, status, result interface{}) error }); ok {
...
func (s *StorageAdapter) GetPendingBackgroundJobs(ctx context.Context, jobType string, limit int) ([]interface{}, error) {
	dlqRepo := s.DLQ()
	if jobRepo, ok := dlqRepo.(interface{ GetPendingBackgroundJobs(ctx context.Context, jobType string, limit int) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) CreateList(ctx context.Context, list interface{}) error {
	listRepo := s.List()
	if createRepo, ok := listRepo.(interface{ CreateList(ctx context.Context, list interface{}) error }); ok {
...
func (s *StorageAdapter) GetList(ctx context.Context, listID string) (interface{}, error) {
	listRepo := s.List()
	if getRepo, ok := listRepo.(interface{ GetList(ctx context.Context, listID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdateList(ctx context.Context, list interface{}) error {
	listRepo := s.List()
	if updateRepo, ok := listRepo.(interface{ UpdateList(ctx context.Context, list interface{}) error }); ok {
...
func (s *StorageAdapter) DeleteList(ctx context.Context, listID string) error {
	listRepo := s.List()
	if deleteRepo, ok := listRepo.(interface{ DeleteList(ctx context.Context, listID string) error }); ok {
...
func (s *StorageAdapter) GetListsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	listRepo := s.List()
	if getUserRepo, ok := listRepo.(interface{ GetListsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) AddListMember(ctx context.Context, listID, username string) error {
	listRepo := s.List()
	if addRepo, ok := listRepo.(interface{ AddListMember(ctx context.Context, listID, username string) error }); ok {
...
func (s *StorageAdapter) RemoveListMember(ctx context.Context, listID, username string) error {
	listRepo := s.List()
	if removeRepo, ok := listRepo.(interface{ RemoveListMember(ctx context.Context, listID, username string) error }); ok {
...
func (s *StorageAdapter) GetListMembers(ctx context.Context, listID string, limit int, cursor string) ([]interface{}, string, error) {
	listRepo := s.List()
	if getMembersRepo, ok := listRepo.(interface{ GetListMembers(ctx context.Context, listID string, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) IsListMember(ctx context.Context, listID, username string) (bool, error) {
	listRepo := s.List()
	if memberRepo, ok := listRepo.(interface{ IsListMember(ctx context.Context, listID, username string) (bool, error) }); ok {
...
func (s *StorageAdapter) GetUserLists(ctx context.Context, username string) ([]interface{}, error) {
	listRepo := s.List()
	if userListsRepo, ok := listRepo.(interface{ GetUserLists(ctx context.Context, username string) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) CreatePoll(ctx context.Context, poll interface{}) error {
	pollRepo := s.Poll()
	if createRepo, ok := pollRepo.(interface{ CreatePoll(ctx context.Context, poll interface{}) error }); ok {
...
func (s *StorageAdapter) GetPoll(ctx context.Context, pollID string) (interface{}, error) {
	pollRepo := s.Poll()
	if getRepo, ok := pollRepo.(interface{ GetPoll(ctx context.Context, pollID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdatePoll(ctx context.Context, poll interface{}) error {
	pollRepo := s.Poll()
	if updateRepo, ok := pollRepo.(interface{ UpdatePoll(ctx context.Context, poll interface{}) error }); ok {
...
func (s *StorageAdapter) GetPollsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	pollRepo := s.Poll()
	if getUserRepo, ok := pollRepo.(interface{ GetPollsByUser(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) CastPollVote(ctx context.Context, vote interface{}) error {
	pollRepo := s.Poll()
	if voteRepo, ok := pollRepo.(interface{ CastPollVote(ctx context.Context, vote interface{}) error }); ok {
...
func (s *StorageAdapter) GetPollVote(ctx context.Context, pollID, voterID string) (interface{}, error) {
	pollRepo := s.Poll()
	if getVoteRepo, ok := pollRepo.(interface{ GetPollVote(ctx context.Context, pollID, voterID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) GetPollResults(ctx context.Context, pollID string) (interface{}, error) {
	pollRepo := s.Poll()
	if resultsRepo, ok := pollRepo.(interface{ GetPollResults(ctx context.Context, pollID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) CreateHashtag(ctx context.Context, hashtag interface{}) error {
	hashtagRepo := s.Hashtag()
	if createRepo, ok := hashtagRepo.(interface{ CreateHashtag(ctx context.Context, hashtag interface{}) error }); ok {
...
func (s *StorageAdapter) GetHashtag(ctx context.Context, name string) (interface{}, error) {
	hashtagRepo := s.Hashtag()
	if getRepo, ok := hashtagRepo.(interface{ GetHashtag(ctx context.Context, name string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdateHashtag(ctx context.Context, hashtag interface{}) error {
	hashtagRepo := s.Hashtag()
	if updateRepo, ok := hashtagRepo.(interface{ UpdateHashtag(ctx context.Context, hashtag interface{}) error }); ok {
...
func (s *StorageAdapter) IncrementHashtagUsage(ctx context.Context, name string) error {
	hashtagRepo := s.Hashtag()
	if incRepo, ok := hashtagRepo.(interface{ IncrementHashtagUsage(ctx context.Context, name string) error }); ok {
...
func (s *StorageAdapter) GetHashtagsByPopularity(ctx context.Context, limit int, since time.Time) ([]interface{}, error) {
	hashtagRepo := s.Hashtag()
	if popularRepo, ok := hashtagRepo.(interface{ GetHashtagsByPopularity(ctx context.Context, limit int, since time.Time) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) FollowHashtag(ctx context.Context, username, hashtagName string) error {
	hashtagRepo := s.Hashtag()
	if followRepo, ok := hashtagRepo.(interface{ FollowHashtag(ctx context.Context, username, hashtagName string) error }); ok {
...
func (s *StorageAdapter) UnfollowHashtag(ctx context.Context, username, hashtagName string) error {
	hashtagRepo := s.Hashtag()
	if unfollowRepo, ok := hashtagRepo.(interface{ UnfollowHashtag(ctx context.Context, username, hashtagName string) error }); ok {
...
func (s *StorageAdapter) IsFollowingHashtag(ctx context.Context, username, hashtagName string) (bool, error) {
	hashtagRepo := s.Hashtag()
	if followingRepo, ok := hashtagRepo.(interface{ IsFollowingHashtag(ctx context.Context, username, hashtagName string) (bool, error) }); ok {
...
func (s *StorageAdapter) GetFollowedHashtags(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) {
	hashtagRepo := s.Hashtag()
	if followedRepo, ok := hashtagRepo.(interface{ GetFollowedHashtags(ctx context.Context, username string, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) CreateAnnouncement(ctx context.Context, announcement interface{}) error {
	...
	if createRepo, ok := annRepo.(interface{ CreateAnnouncement(ctx context.Context, announcement interface{}) error }); ok {
...
func (s *StorageAdapter) GetAnnouncement(ctx context.Context, announcementID string) (interface{}, error) {
	annRepo := s.Announcement()
	if getRepo, ok := annRepo.(interface{ GetAnnouncement(ctx context.Context, announcementID string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) UpdateAnnouncement(ctx context.Context, announcement interface{}) error {
	annRepo := s.Announcement()
	if updateRepo, ok := annRepo.(interface{ UpdateAnnouncement(ctx context.Context, announcement interface{}) error }); ok {
...
func (s *StorageAdapter) DeleteAnnouncement(ctx context.Context, announcementID string) error {
	annRepo := s.Announcement()
	if deleteRepo, ok := annRepo.(interface{ DeleteAnnouncement(ctx context.Context, announcementID string) error }); ok {
...
func (s *StorageAdapter) GetActiveAnnouncements(ctx context.Context) ([]interface{}, error) {
	annRepo := s.Announcement()
	if activeRepo, ok := annRepo.(interface{ GetActiveAnnouncements(ctx context.Context) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) GetAllAnnouncements(ctx context.Context, limit int, cursor string) ([]interface{}, string, error) {
	annRepo := s.Announcement()
	if allRepo, ok := annRepo.(interface{ GetAllAnnouncements(ctx context.Context, limit int, cursor string) ([]interface{}, string, error) }); ok {
...
func (s *StorageAdapter) DismissAnnouncement(ctx context.Context, username, announcementID string) error {
	annRepo := s.Announcement()
	if dismissRepo, ok := annRepo.(interface{ DismissAnnouncement(ctx context.Context, username, announcementID string) error }); ok {
...
func (s *StorageAdapter) AddAnnouncementReaction(ctx context.Context, username, announcementID, emoji string) error {
	annRepo := s.Announcement()
	if reactionRepo, ok := annRepo.(interface{ AddAnnouncementReaction(ctx context.Context, username, announcementID, emoji string) error }); ok {
...
func (s *StorageAdapter) RemoveAnnouncementReaction(ctx context.Context, username, announcementID, emoji string) error {
	annRepo := s.Announcement()
	if reactionRepo, ok := annRepo.(interface{ RemoveAnnouncementReaction(ctx context.Context, username, announcementID, emoji string) error }); ok {
...
func (s *StorageAdapter) GetInfrastructureHealth(ctx context.Context) (*model.InfrastructureStatus, error) {
...
func (s *StorageAdapter) GetInstanceBudgets(ctx context.Context, exceeded *bool) ([]*model.InstanceBudget, error) {
...
func (s *StorageAdapter) GetInstanceHealthReport(ctx context.Context, domain string) (*model.InstanceHealthReport, error) {
	instanceRepo := s.Instance()
	if healthRepo, ok := instanceRepo.(interface{ GetInstanceHealthReport(ctx context.Context, domain string) (*model.InstanceHealthReport, error) }); ok {
...
func (s *StorageAdapter) GetInstanceRelationships(ctx context.Context, domain string) (*model.InstanceRelations, error) {
	instanceRepo := s.Instance()
	if relRepo, ok := instanceRepo.(interface{ GetInstanceRelationships(ctx context.Context, domain string) (*model.InstanceRelations, error) }); ok {
...
func (s *StorageAdapter) GetDatabaseStatus(ctx context.Context) (interface{}, error) {
...
func (s *StorageAdapter) GetDatabaseMetrics(ctx context.Context, since time.Time) (interface{}, error) {
	costRepo := s.Cost()
	if metricsRepo, ok := costRepo.(interface{ GetDatabaseMetrics(ctx context.Context, since time.Time) (interface{}, error) }); ok {
...
func (s *StorageAdapter) RecordDatabaseError(ctx context.Context, operation string, err error) error {
	auditRepo := s.Audit()
	if errorRepo, ok := auditRepo.(interface{ RecordDatabaseError(ctx context.Context, operation string, err error) error }); ok {
...
func (s *StorageAdapter) RecordServiceHealth(ctx context.Context, service string, status interface{}, metrics map[string]interface{}) error {
	auditRepo := s.Audit()
	if healthRepo, ok := auditRepo.(interface{ RecordServiceHealth(ctx context.Context, service string, status interface{}, metrics map[string]interface{}) error }); ok {
...
func (s *StorageAdapter) GetServiceHealth(ctx context.Context, service string) (interface{}, error) {
	auditRepo := s.Audit()
	if healthRepo, ok := auditRepo.(interface{ GetServiceHealth(ctx context.Context, service string) (interface{}, error) }); ok {
...
func (s *StorageAdapter) GetAllServiceHealth(ctx context.Context) ([]interface{}, error) {
	auditRepo := s.Audit()
	if allHealthRepo, ok := auditRepo.(interface{ GetAllServiceHealth(ctx context.Context) ([]interface{}, error) }); ok {
...
func (s *StorageAdapter) GetStorageInfo(ctx context.Context) (interface{}, error) {
...
func (s *StorageAdapter) GetStorageStatistics(ctx context.Context) (interface{}, error) {
	costRepo := s.Cost()
	if statsRepo, ok := costRepo.(interface{ GetStorageStatistics(ctx context.Context) (interface{}, error) }); ok {
...
func (s *StorageAdapter) PerformMaintenance(ctx context.Context, operation interface{}) error {
...
func (s *StorageAdapter) GetMaintenanceStatus(ctx context.Context) (interface{}, error) {
...
func (s *StorageAdapter) GetMigrationStatus(ctx context.Context) (interface{}, error) {
	status := map[string]interface{}{
...
func (s *StorageAdapter) UpdateMigrationProgress(ctx context.Context, step string, progress int) error {
...
func (t *transactionAdapter) TxUpdateObject(objectID string, object interface{}) error {
...
func (t *transactionAdapter) TxUpdateActivity(activity *activitypub.Activity) error {
...
func (t *transactionAdapter) TxDeleteActivity(activityID string) error {
	// For now, this is a placeholder for transaction functionality
	// In full transaction implementation, this would be part of the transaction batch
...
func (t *transactionAdapter) TxUpdateRelationshipStatus(followerUsername, followingID string, status string) error {
	// For now, delegate to the regular repository method
	// In full transaction implementation, this would be part of the transaction batch
