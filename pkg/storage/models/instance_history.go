...
type InstanceHistory struct {
	...
	GSI1PK string `theorydb:"index:gsi1,pk,attr:gsi1PK,omitempty"` // METRIC#{metric_type}
	GSI1SK string `theorydb:"index:gsi1,sk,attr:gsi1SK,omitempty"` // DATE#{YYYY-MM-DD}
