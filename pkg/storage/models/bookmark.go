...
type Bookmark struct {
	...
	SK string `dynamorm:"sk" json:"-"` // TIME#timestamp#objectID or OBJECT#objectID
	...
	TimeRecordSK string `json:"time_record_sk,omitempty"` // OBJECT records keep a pointer to the TIME SK
