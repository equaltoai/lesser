...
type Block struct {
	...
	GSI5PK string `theorydb:"index:gsi5,pk,attr:gsi5PK,omitempty" json:"gsi5PK"` // BLOCKED#{blocked_username}
	GSI5SK string `theorydb:"index:gsi5,sk,attr:gsi5SK,omitempty" json:"gsi5SK"` // BLOCKER#{blocker_username}
