...
func NewMockRepositoryStorage() *MockRepositoryStorage {
	...
	timelineRepo := repositories.NewTimelineRepository(nil, "test-table", logger, nil)
	notificationRepo := repositories.NewNotificationRepository(nil, "test-table", logger, nil)
	...
	listRepo := repositories.NewListRepository(nil, "test-table", logger, nil)
	mediaRepo := repositories.NewMediaRepository(nil, "test-table", logger, nil)
	mediaMetadataRepo := repositories.NewMediaMetadataRepository(nil, "test-table", logger, nil)
	pollRepo := repositories.NewPollRepository(nil, "test-table", logger, nil)
	hashtagRepo := repositories.NewHashtagRepository(nil, "test-table", logger, "test.example.com")
	scheduledStatusRepo := repositories.NewScheduledStatusRepository(nil, "test-table", logger, nil)
