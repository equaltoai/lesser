...
func (s *serviceTestStorage) MediaAnalytics() *repositories.MediaAnalyticsRepository { return nil }
func (s *serviceTestStorage) MediaPopularity() *repositories.MediaPopularityRepository { return nil }
func (s *serviceTestStorage) MediaSession() *repositories.MediaSessionRepository { return nil }
func (s *serviceTestStorage) StreamingConnection() *repositories.StreamingConnectionRepository { return nil }
func (s *serviceTestStorage) Article() *repositories.ArticleRepository         { return nil }
func (s *serviceTestStorage) Draft() *repositories.DraftRepository             { return nil }
func (s *serviceTestStorage) Revision() *repositories.RevisionRepository       { return nil }
func (s *serviceTestStorage) Series() *repositories.SeriesRepository           { return nil }
func (s *serviceTestStorage) Category() *repositories.CategoryRepository       { return nil }
func (s *serviceTestStorage) Publication() *repositories.PublicationRepository { return nil }
func (s *serviceTestStorage) PublicationMember() *repositories.PublicationMemberRepository { return nil }
