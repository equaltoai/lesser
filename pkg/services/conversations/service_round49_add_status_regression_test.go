...
func TestService_SendMessage_DoesNotCallAddStatusToConversation(t *testing.T) {
	...
	conversationRepo.On("GetConversationParticipantRecord", ctx, "conv-add-status", "bob").
		Return(&models.ConversationParticipantRecord{RequestState: models.DmRequestStateAccepted}, nil).
		Once()
	conversationRepo.On("GetConversationParticipantRecord", ctx, "conv-add-status", "alice").
		Return(&models.ConversationParticipantRecord{RequestState: models.DmRequestStateAccepted}, nil).
		Once()
